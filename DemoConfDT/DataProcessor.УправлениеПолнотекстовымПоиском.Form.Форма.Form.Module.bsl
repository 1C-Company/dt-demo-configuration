...
Процедура ОбновитьСтатусВыполнить()
	...
	Если ПолнотекстовыйПоиск.ПолучитьРежимПолнотекстовогоПоиска() = РежимПолнотекстовогоПоиска.Разрешить Тогда
		...
		Если ПолнотекстовыйПоиск.ИндексАктуален() Тогда
			СтатусИндекса = Новый ФорматированнаяСтрока(НСтр("ru = 'Обновление индекса не требуется'", "ru"));
		Иначе                                                 
			СтатусИндекса = Новый ФорматированнаяСтрока(НСтр("ru = 'Требуется обновление индекса'", "ru"));
		КонецЕсли;
